...
export const runtimeContract = {
  ...
  resources: {
    local: {
      workerName: "aspt-nine-centers-cobalt",
      d1DatabaseName: "aspt-nine-centers-cobalt-site",
      r2BucketName: "aspt-nine-centers-cobalt-media",
      kvNamespaceName: "LOCAL_ASPT_NINE_CENTERS_COBALT_SESSION_KV",
    },
    preview: {
      workerName: "aspt-nine-centers-cobalt-preview",
      d1DatabaseName: "aspt-nine-centers-cobalt-preview-site",
      r2BucketName: "aspt-nine-centers-cobalt-preview-media",
      kvNamespaceName: "aspt-nine-centers-cobalt-preview-session",
    },
    production: {
      workerName: "aspt-nine-centers-cobalt-production",
      d1DatabaseName: "aspt-nine-centers-cobalt-production-site",
      r2BucketName: "aspt-nine-centers-cobalt-production-media",
      kvNamespaceName: "aspt-nine-centers-cobalt-production-session",
    },
  },
